...
void MCAL_SPI_Init (SPI_TypeDef *SPIx, SPI_Config* SPI_Config)
{
	...
	if		(SPIx == SPI1) 		{	RCC_SPI1_CLK_EN();	Global_SPI_Config1 = *SPI_Config; 	Global_SPI_Config[SPI1_INDEX] = &Global_SPI_Config1;	}
	else if	(SPIx == SPI2) 		{	RCC_SPI2_CLK_EN();	Global_SPI_Config2 = *SPI_Config;	Global_SPI_Config[SPI2_INDEX] = &Global_SPI_Config2;	}
