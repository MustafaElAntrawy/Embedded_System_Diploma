...
void MCAL_UART_Init (USART_TypeDef* USARTx, UART_Config* UART_Config)
{
	...
	if		(USARTx == USART1) 		{	RCC_USART1_CLK_EN();	Global_UART_Config1 = *UART_Config; 	Global_UART_Config[0] = &Global_UART_Config1;	}
	else if	(USARTx == USART2) 		{	RCC_USART2_CLK_EN();	Global_UART_Config2 = *UART_Config;		Global_UART_Config[1] = &Global_UART_Config2;	}
	else if	(USARTx == USART3) 		{	RCC_USART3_CLK_EN();	Global_UART_Config3 = *UART_Config;		Global_UART_Config[2] = &Global_UART_Config3;	}
