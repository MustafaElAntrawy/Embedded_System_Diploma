...
//Clock Enable USART
#define RCC_UASRT1_CLK_EN()								(RCC->APB2ENR |= 1<<14)
#define RCC_UASRT2_CLK_EN()								(RCC->APB1ENR |= 1<<17)
#define RCC_UASRT3_CLK_EN()								(RCC->APB1ENR |= 1<<18)

//RCC Reset mechanism
#define RCC_UASRT1_Reset()								(RCC->APB2RSTR |= 1<<14)
#define RCC_UASRT2_Reset()								(RCC->APB1RSTR |= 1<<17)
#define RCC_UASRT3_Reset()								(RCC->APB1RSTR |= 1<<18)
